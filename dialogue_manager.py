...
class ThreadRanker(object):
    def __init__(self, paths):
        ...
        self.word_embeddings = KeyedVectors.load_word2vec_format('GoogleNews-vectors-negative300.bin.gz', binary=True, limit=500000)
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchat_bot = ChatBot('ChatBot', trainer="chatterbot.trainers.ChatterBotCorpusTrainer")
